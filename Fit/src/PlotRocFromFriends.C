...
int PlotRocFromFriends(float PtMin=80,float PtMax=120., float RhoMin=5, float RhoMax=15 ){
...
TH1F* o1=new TH1F("o1","o1",400,-20,20); //QGL1 old
TH1F* o2=new TH1F("o2","o2",400,-20,20);
...
a->AddFriend(t,"old");
cout<<"QGL 4var"<<endl;
a->Draw("-1./TMath::Tan(TMath::TwoPi()*old.QGL)>>o1",Form("%f<ptJet0 && ptJet0<%f && %f<rhoPF && rhoPF<%f && abs(etaJet0)<2.0 && abs(pdgIdPartJet0)<4",PtMin,PtMax,RhoMin,RhoMax),"goff");
a->Draw("-1./TMath::Tan(TMath::TwoPi()*old.QGL)>>o2",Form(" %f<ptJet0 && ptJet0<%f && %f<rhoPF && rhoPF<%f && abs(etaJet0)<2.0 && abs(pdgIdPartJet0)==21",PtMin,PtMax,RhoMin,RhoMax),"goff");
cout<<"DONE"<<endl;
cout<<"DONE"<<endl;
