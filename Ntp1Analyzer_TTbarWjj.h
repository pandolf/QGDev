...
#ifndef Ntp1Analyzer_TTbarWjj_h
#define Ntp1Analyzer_TTbarWjj_h

#include "Ntp1Analyzer.h"
#include "TH1F.h"

#include "UserCode/pandolf/QGLikelihood/interface/QGLikelihoodCalculator.h"


class Ntp1Analyzer_TTbarWjj : public Ntp1Analyzer {

 public:

   Ntp1Analyzer_TTbarWjj( const std::string& dataset, const std::string& flags="", TTree* tree=0);
   virtual ~Ntp1Analyzer_TTbarWjj();
